-- can use this file to  re-create database
...
INSERT INTO  AJABU_VISITORS ( Visitor_email, LastName, FirstName) VALUES 
	( 'Fanta@fanta.com', 'ajabu', 'joy' ),
	( 'Matengee@gmail.com', 'Wangui', 'Njenga' ),
	( 'Carol@carol.com', 'Wangui', 'Njenga' )
;